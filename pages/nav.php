...
switch($tbl){
	...
	case "finance_payments":inmenu(["new/finance_arrears","new/receipts","new/finance_stats","new/finance_list"]);break;
	case "receipts":inmenu(["new/finance_payments"]);break;
	case "finance_list":inmenu(["new/finance_payments","new/finance_set_serial",]);break;
